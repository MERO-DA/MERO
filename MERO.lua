...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʀᴀᴛᴇʀ\n\n[⋄  ʀᴀᴛᴇʀ ᴄʜᴀɴɴᴇʟ](http://t.me/tttttuiopk)\n\n[⋄  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/tttttuiopk)\n\n[⋄  ʀᴀᴛᴇʀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/K_k_k_ksa)\n\n[⋄  ʙᴏᴛ ʀᴀᴛᴇʀ](http://t.me/K_k_k_ksa)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⋄ sᴏᴜʀᴄʀ ʀᴀᴛᴇʀ',url="t.me/tttttuiopk"}},
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '- MeRo TeMe .', url="t.me/tttttuiopk"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '- MeRo TeMe .', url="t.me/tttttuiopk"}},}
