...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MERO-DA/Files_MERO/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "YYYUK")
...
if not DevMEROW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMEROW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ⌯' and DevMEROW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevMEROW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevMEROW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevMEROW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevMEROW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevMEROW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevMEROW(msg) then 
...
if text == 'قناه تحديثات البوت ⌯' and DevMEROW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/YYYDR) \n⌯︙[قناه السورس](t.me/YYYUK)')
end
if text == "ضع اسم للبوت ⌯" and DevMEROW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevMEROW(msg) then 
...
if text == 'المشتركين ⌯' and DevMEROW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevMEROW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevMEROW(msg) then
...
if text == ("قائمه العام ⌯") and DevMEROW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevMEROW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevMEROW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevMEROW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevMEROW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevMEROW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevMEROW(msg) then 
...
if text == "تنظيف الكروبات ⌯" and DevMEROW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور @(.*)$") and DevMEROW(msg) then
...
usertext = '*\n ⌯︙العضو »* ['..result.title_..'](t.me/'..(username or 'YYYUK')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevMEROW(msg) then
...
usertext = '\n *⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'YYYUK')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMEROW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMEROW(msg) then
...
if MERO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'YYYUK')..') \n ⌯︙'..MERO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/YYYUK)}\n⌯︙["..MERO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا »* {["..data.first_name_.."](T.ME/YYYUK)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMEROW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMEROW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMEROW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevMEROW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevMEROW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevMEROW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevMEROW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevMEROW(msg) then  
...
database:sadd(bot_id.."MERO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MERO:blocname"..msg.chat_id_)
...
if name_MERO then 
names_MERO = database:smembers(bot_id.."MERO:blocname"..msg.chat_id_) or ""
if names_MERO and names_MERO[1] then 
for i=1,#names_MERO do 
if name_MERO:match("(.*)("..names_MERO[i]..")(.*)") then 
...
database:set(bot_id.."MERO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MERO:nump"..msg.chat_id_,nump)
end
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MERO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_MEROa_new(MERO1,MERO2)
if MERO2 and MERO2.first_name_ then 
if MERO2.first_name_:match("(.*)"..database:get(bot_id.."MERO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MERO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local MERO_nnn = database:get(bot_id.."MERO:nump"..msg.chat_id_) or 5
local MERO_nnn2 = database:get(bot_id.."MERO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(MERO_nnn2) == tonumber(MERO_nnn) or tonumber(MERO_nnn2) > tonumber(MERO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MERO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..MERO2.username_.."](https://t.me/"..(MERO2.username_ or "YYYUK")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MERO:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(MERO_nnn) - tonumber(MERO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_MEROa_new)
end
end
...
local MEROChengName = database:get(bot_id.."MERO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MEROChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MEROChengName..']')
database:del(bot_id.."MERO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MEROChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MERO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MEROChengUserName = database:get(bot_id.."MERO:Cheng:UserName"..data.id_)
if not data.username_ then 
if MEROChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MEROChengUserName..']')
database:del(bot_id.."MERO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MEROChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MERO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MEROChengPhoto = database:get(bot_id.."MERO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MEROChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MERO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MEROChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MERO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
{
{text = 'لتنصيب السوࢪس 💘',url="https://t.me/YYYDR/3"},
},
{
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'YYYUK')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'YYYUK')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == ("مسح قائمه العام") and DevMEROW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMEROW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevMEROW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevMEROW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMEROW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevMEROW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevMEROW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMEROW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevMEROW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevMEROW(msg) then
...
if text == 'الملفات' and DevMEROW(msg) then
t = ' *⌯︙ملفات السورس ميرو ↓*\n*•━━━━━━ 𝗧𝗘 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevMEROW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MERO-DA/Files_MERO/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفات ميرو*\n*⌯︙ملفات السورس ↓*\n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n *⌯︙علامة تعني { ✓ } ملف مفعل*\n *⌯︙علامة تعني { ✘ } ملف معطل*\n *⌯︙قناة سورس ميرو ↓*\n".." *⌯︙*[اضغط هنا لدخول](t.me/YYYUK) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMEROW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MERO-DA/Files_MERO/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMEROW(msg) then
...
if text == "مسح الملفات" and DevMEROW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMEROW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMEROW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "YYYUK")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'YYYUK')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'YYYUK')..')'
...
if text == 'مسح كليشه المطور' and DevMEROW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevMEROW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'YYYUK')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevMEROW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMEROW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevMEROW(msg) then 
...
if MEROSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevMEROW(msg) then 
...
if text == ("ردود المطور") and DevMEROW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMEROW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevMEROW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevMEROW(msg) then   
...
if text == 'تعطيل المغادره' and DevMEROW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'YYYUK')..')'
local iduser = result.sender_user_id_
...
if text == 'استعاده الاوامر' and DevMEROW(msg) then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀.',url="t.me/YYYDR"}},
}
local msg_id = msg.id_/2097152/0.5
