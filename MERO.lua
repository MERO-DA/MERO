...
io.popen("cd library && wget https://raw.githubusercontent.com/MERO-DA/MERO/main/library/redis.lua") 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMEROW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⋄ sᴏᴜʀᴄʀ ᴍᴇʀᴏ',url="t.me/YYYKU"}},
}
local msg_id = msg.id_/2097152/0.5
...
local TEXT_SUD = database:get(bot_id..'MERO:TEXT_SUDO')
if TEXT_SUDO then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,MERO)
local t = "\n*ツ قائمة الاعضاء* \n*— — — — — — — — — — — — — —*\n"
x = 0
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⋄︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'YYYKU')..') '
...
{{text = 'sᴏᴜʀᴄʀ ᴍᴇʀᴏ',url='http://t.me/YYYKU'}},
}
