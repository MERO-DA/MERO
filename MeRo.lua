...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘔𝘦𝘙𝘰.")  
...
-------------
if text == "🐉 حصريات و تحديثات ميرو 🐉" and DevoMr(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس ميرو*
...
local UserName = (b.username_ or "SRC-MeRo")
...
database:sadd(bot_id.."FEEEM:allM"..msg.chat_id_, msg.id_)
end
...
if text and not database:get(bot_id.."y:FEEEM:allM"..msg.chat_id_) then    
...
if database:sismember(bot_id..'FEEEM:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'FEEEM:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘔𝘦𝘙𝘰.',url="t.me/YYYDR"}},
}
local msg_id = msg.id_/2097152/0.5
...
if database:get(bot_id.."YYYDR:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ميرو يعني لو بكتهن راح اعرفك انت الاخذتهن
...
if text == "تعطيل المسح التلقائي" and CoSu(msg) then        
database:set(bot_id.."FEEEM:MN:TF"..msg.chat_id_)
Reply_Status(msg,msg.sender_user_id_,"lock",'*⋄︙تم تعطيل المسح التلقائي للميديا*')
return false
end 
if text == "تفعيل المسح التلقائي" and CoSu(msg) then        
database:set(bot_id.."FEEEM:MN:TF"..msg.chat_id_,true)
