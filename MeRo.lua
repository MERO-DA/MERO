...
--------------------------------------------------------------------------------------------------------------
function SourceMeRo(msg,data) -- بداية العمل عمـر الـ دلـيـم
if msg then
...
send(msg.chat_id_, msg.id_, "*⋄︙عذرآ لا يمكنك حظر المطور الاساسي* \n")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, "*⋄︙عذرآ لا يمكنك كتم المطور الاساسي* \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1425830897) then  
...
st = https.request('https://FEEEM.ml/Imagelnfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
send(msg.chat_id_, msg.id_,"*⋄︙لا تستطيع طرد مطور السورس او الاساسي*")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
function start_function(extra, result, success)
if MeRoSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⋄︙⋄︙لا تستطيع حظر مطور السورس او الاساسي*")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if MeRoSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⋄︙لا تستطيع كتم مطور السورس او الاساسي*")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
...
function start_function(extra, result, success)
if MeRoSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⋄︙لا تستطيع تقيد مطور السورس او الاساسي*")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
function start_function(extra, result, success)
if MeRoSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_," *⋄︙سرسح لا تستطيع تنزيل مطور السورس او الاساسي*")
return false 
end
...
zh = https.request('https://vvvzvv.ml/amirZhfa/MeRo.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⋄︙قائمه الزخرفه* \nٴ⋄∫ٴ*ٴ— — — — — — — — — — — — — —*ٴ⋄∫○ٴ \n"
i = 0
...
gk = https.request('https://vvvzvv.ml/amirBrg/MeRo.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/MeRo.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/MeRo.php')
if res == 200 then
